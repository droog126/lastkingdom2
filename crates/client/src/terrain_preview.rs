...
const STABILIZATION_FRAMES: u64 = 110;
...
fn setup_world(
    ...
    let grass = materials.add(StandardMaterial {
        base_color: Color::srgb(0.40, 0.64, 0.25),
        perceptual_roughness: 0.86,
        ..default()
    });
    let wild_grass = materials.add(StandardMaterial {
        base_color: Color::srgb(0.30, 0.55, 0.21),
        perceptual_roughness: 0.92,
        ..default()
    });
    let road = materials.add(StandardMaterial {
        base_color: Color::srgb(0.63, 0.63, 0.57),
    ...
    spawn_village_roads(&mut commands, &mut meshes, &road);
...
fn setup_camera(mut commands: Commands) {
    commands.spawn((
        ...
        Transform::from_xyz(27.0, 34.0, 31.0).looking_at(Vec3::new(4.0, 0.0, 1.0), Vec3::Y),
...
fn spawn_wild_side(
    ...
    for i in 0..10 {
        ...
        spawn_asset(commands, asset_server, state, "procedural/pretty/rabbit.glb", Vec3::new(x, 0.0, z), 0.55, hash01(i, 47) * std::f32::consts::TAU);
    }
}

fn spawn_village_roads(commands: &mut Commands, meshes: &mut ResMut<Assets<Mesh>>, road: &Handle<StandardMaterial>) {
    ...
    for x in [-2.0, 10.0, 22.0, 34.0] {
        commands.spawn((
            ...
            Transform::from_xyz(x, 0.02, 0.0).with_scale(Vec3::new(2.0, 1.0, 64.0)),
        ));
    }
    for z in [-24.0, -8.0, 8.0, 24.0] {
        commands.spawn((
            Mesh3d(road_mesh.clone()),
            MeshMaterial3d(road.clone()),
            Transform::from_xyz(16.0, 0.025, z).with_scale(Vec3::new(42.0, 1.0, 2.0)),
        ));
    }
}
...
fn spawn_farms(
    ...
    for (cx, cz, sx, sz) in [(4.0, -18.0, 7.0, 8.0), (28.0, -17.0, 8.0, 8.0), (16.0, 18.0, 10.0, 7.0)] {
        commands.spawn((
...
fn spawn_village_decor(
    ...
    for (x, z) in [(0.0, -24.0), (12.0, -8.0), (24.0, 8.0), (36.0, 24.0)] {
    ...
    for (x, z) in [(3.0, 8.0), (12.0, 24.0), (30.0, -26.0), (34.0, -8.0)] {
