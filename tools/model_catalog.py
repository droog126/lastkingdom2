...
def _scale(
    ...
    *assets: str,
    ...
    contract = ScaleContract(metric, target_meters, grounded)
    for asset in assets:
...
_scale("pretty", "max_extent", 1.5, "monster_snake")
_scale("pretty", "height", 1.8, "monster_frost_elf")
_scale("pretty", "max_extent", 2.2, "monster_sand_wurm")
_scale("pretty", "height", 3.2, "monster_treant")
_scale("pretty", "height", 2.0, "monster_aether_wraith", grounded=False)
_scale("pretty", "max_extent", 4.0, "cloud_puff", grounded=False)
...
_scale("pretty", "max_extent", 1.2, "fallen_stick")
_scale("pretty", "max_extent", 0.9, "rock_dark")
_scale("pretty", "max_extent", 0.75, "rock_mid")
_scale("pretty", "max_extent", 0.65, "rock_moss")
_scale("pretty", "height", 0.45, "flower_0", "flower_1", "flower_2", "flower_3", "flower_4")
_scale("pretty", "max_extent", 8.0, "hill")
...
_scale("pretty", "max_extent", 12.0, "ground_disc_outer")
_scale("pretty", "max_extent", 5.0, "ground_disc_inner")

_scale("pretty", "max_extent", 12.0, "mountain_snow")
_scale("pretty", "max_extent", 10.0, "volcano")
_scale("pretty", "max_extent", 8.0, "desert_dune", "lake", "beach")
_scale("pretty", "max_extent", 7.0, "swamp")
_scale("pretty", "max_extent", 8.0, "cliff")
_scale("pretty", "height", 5.0, "cave_entrance")
_scale("pretty", "max_extent", 6.0, "ground_patch")

_scale("pretty", "height", 4.0, "house_small")
_scale("pretty", "height", 6.0, "watchtower", "windmill")
_scale("pretty", "max_extent", 8.0, "bridge_stone", "pier")
...
_scale("pretty", "max_extent", 5.0, "boat")
_scale("pretty", "height", 3.5, "arch_stone")
_scale("pretty", "max_extent", 3.0, "cart")
_scale("pretty", "height", 1.5, "tombstone")
_scale("pretty", "height", 2.0, "haystack", "cooking_station")
_scale("pretty", "height", 1.8, "spit_roast")
_scale("pretty", "max_extent", 2.2, "wolf")
_scale("pretty", "height", 1.7, "bear")

_scale("pretty", "height", 2.0, "sword")
_scale("pretty", "height", 3.0, "hoplite_reaper_scythe")
_scale("pretty", "height", 2.6, "hoplite_dragon_katana")
_scale("pretty", "height", 2.4, "hoplite_golem_hammer")
_scale("pretty", "height", 2.5, "hoplite_midas_sword")
_scale("pretty", "max_extent", 6.0, "hoplite_ender_dragon")

_scale("eco", "height", 0.65, "rabbit")
_scale("eco", "height", 1.1, "berry_bush")
_scale("eco", "max_extent", 0.25, "berry_fruit")
_scale("eco", "max_extent", 0.8, "co2_bubble", grounded=False)
